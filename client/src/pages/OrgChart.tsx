...
const getRoleColor = (role: string) => {
  const map: Record<string, string> = {
    ...
    SUPERVISOR: 'from-cyan-500/80 to-cyan-500 text-cyan-400 border-cyan-500/30 bg-cyan-500/10',
    EMPLOYEE: 'from-emerald-500/80 to-emerald-500 text-emerald-400 border-emerald-500/30 bg-emerald-500/10'
  };
  return map[role] || 'from-slate-500/80 to-slate-500 text-slate-400 border-slate-500/30 bg-slate-500/10';
};
...
const getRoleGradientOnly = (role: string) => {
  const map: Record<string, string> = {
    ...
    SUPERVISOR: 'from-cyan-500/80 to-cyan-500',
    EMPLOYEE: 'from-emerald-500/80 to-emerald-500'
  };
