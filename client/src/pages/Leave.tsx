...
const Leave = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const leaveRows = Array.isArray(leavesRes.data?.leaves) ? leavesRes.data.leaves : Array.isArray(leavesRes.data) ? leavesRes.data : [];
      setLeaves(leaveRows);
      setBalance(balanceRes.data && typeof balanceRes.data === 'object' ? balanceRes.data : { leaveBalance: 0, leaveAllowance: 0 });
