...
const DevDashboard = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            setHealth(hRes.data && typeof hRes.data === "object" ? hRes.data : {});
            setSettings(sRes.data && typeof sRes.data === "object" ? sRes.data : {});
    ...
    const handleSaveSettings = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.info('System configuration updated safely.');
        } catch (error) {
            toast.info('Failed to update system config.');
        } finally {
            setSaving(false);
        }
    };
