        ...
        <nav className="flex-1 py-8 overflow-y-auto custom-scrollbar overflow-x-hidden">
            <>
              ...
              <NavGroup label={t('common.performance')} isCollapsed={isCollapsed}>
                ...
                {rank >= 90 && (
                  <NavItem to="/reviews/templates" icon={Settings} label={t('common.appraisal_templates')} isCollapsed={isCollapsed} />
                )}
              </NavGroup>
                ...
                <NavGroup label={t('common.administration')} isCollapsed={isCollapsed}>
                  ...
                  {rank >= 85 && (
                    <>
                      ...
                      {rank >= 90 && <NavItem to="/enterprise" icon={Zap} label={t('common.enterprise_suite')} isCollapsed={isCollapsed} />}
                    </>
                  )}
                </NavGroup>
              )}
