...
const ROLE_SUMMARIES: Record<string, { label: string; color: string; desc: string; sees: string[] }> = {
  ...
  HR_MANAGER: { label: 'HR Manager', color: '#ec4899', desc: 'Central HR governance. Manages leave policies, appraisals, and employee dossiers.', sees: ['Employee Management', 'Leave Approval', 'Appraisals', 'Onboarding', 'Enterprise Suite'] },
