...
router.get('/summary', (0, auth_middleware_1.requireRole)(80), payroll_controller_1.getYearlySummary);
router.get('/', (0, auth_middleware_1.requireRole)(80), payroll_controller_1.getRuns);
router.post('/run', (0, auth_middleware_1.requireRole)(80), (0, validate_middleware_1.validate)(validate_middleware_1.PayrollRunSchema), payroll_controller_1.createRun);
router.get('/:id', (0, auth_middleware_1.requireRole)(80), payroll_controller_1.getRunDetail);
