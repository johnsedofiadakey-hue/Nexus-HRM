...
export type ReportingType = 'DIRECT' | 'DOTTED' | 'PROJECT';

/**
 * Get the primary (direct line) manager for an employee.
 */
export const getPrimaryManager = async (employeeId: string, organizationId: string) => {
 ...
 */
export const getAllManagers = async (employeeId: string, organizationId: string) => {
 ...
 */
export const getDirectSubordinates = async (managerId: string, organizationId: string, type: ReportingType = 'DIRECT') => {
  const reportings = await prisma.employeeReporting.findMany({
 ...
 */
export const getAllSubordinatesRecursive = async (managerId: string, organizationId: string): Promise<string[]> => {
 ...
 */
export const assignReporting = async (params: {
 ...
 */
export const migrateSupervisorIds = async (organizationId: string) => {
